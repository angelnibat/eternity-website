ETERNITY WEBSITE — MAC SETUP

1. Download and unzip this folder.
2. Open the folder in Visual Studio Code.
3. Put your background video inside:
   assets/background.mp4

Recommended video:
- MP4 / H.264
- Muted
- 1920×1080 for desktop, or a crop that still looks good vertically
- 10–25 seconds
...
FILES
- index.html: text, sections and links
- style.css: colors, spacing and animations
- script.js: player button and small interactions
- assets/poster.png: fallback image while the video loads
